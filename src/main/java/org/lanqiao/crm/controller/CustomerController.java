...
//    @RequestMapping(value = "index/{pageNum}",method = RequestMethod.GET)
//    public String  selectCustomer(Model model, @PathVariable(value = "pageNum")Integer pageNum,String custName,String custSource,String custIndustry,String ){
//        //分页
//        if (pageNum == null){
//            pageNum = 1;
//        }
//        PageHelper.startPage(pageNum,10);
//        List<Customer> customerList = customerService.getCusetomerByOthers();
//        PageInfo<Customer> page = new PageInfo<Customer>(customerList);
////        page.setList();//这种方法不行分页不显示
//
//        List<BaseDict> customerSources = baseDictService.getCustomerSource("002");
...
//        model.addAttribute("customer",customer);
    ...
    @RequestMapping(value = "indexInsert",method = RequestMethod.PUT)
    @ResponseBody
